            ...
            <tr>
                ...
                <td class="d-flex align-items-center">
                    <a href="<?php echo APP.'/admin/'.$Config['btn'].'/'.$Listing['id'];?>">
                        <?php echo gravatar($Listing['id'],$Listing['firstname'],$Listing['avatar'],'avatar bg-dark text-white fs-xs');?>
                    </a>
                    <div class="ps-3 lh-sm">
                        <a href="<?php echo APP.'/admin/'.$Config['btn'].'/'.$Listing['id'];?>" class="fw-semibold text-current fs-sm d-inline-block">
                            <?php echo $Listing['firstname'].' '.$Listing['lastname'];?></a>
...
<?php } ?>
<!-- .modal -->
<div id="modal-filter" class="modal fade" data-backdrop="true">
